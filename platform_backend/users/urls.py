...
urlpatterns = [
    ...
    path(
        "reset_mail/",
        views.SendMailResetPasswordView.as_view(),
        name="send-mail-reset-password",
    ),
    path(
        "resend_active/", views.ResendActiveView.as_view(), name="resend-active-account"
    ),
    ...
    path("customers/list/", views.ListCustomerView.as_view(), name="get-list-customer"),
    path(
